...
const GnomeCard = ({ gnome }) => {
  return (
    <div className="gnome-card gnome-card-chart" data-test='GnomeCard'>
      ...
      <div className="gnome-card-body">
        <LazyLoad key={gnome.id} placeholder={<Loading />}>
          <Link className="card-link" to={`gnome/${gnome.name}`}>
